...
export const events: VillageEvent[] = [
  {
    ...
    alt: 'DJ working the booth as the floor fills on a Friday night',
    cta: 'Reserve a table',
  ...
  },
  {
    ...
    alt: 'Live band performing to a full room on a Thursday',
    cta: 'Reserve a table',
  ...
  },
  {
    ...
    alt: 'Confetti falling over a private celebration',
    cta: 'Enquire now',
